...
function Navbar() {
    ...
    return (
        <nav className="flex items-center justify-between px-6 py-4 bg-white shadow-md border-b relative">
            ...
            {isOpen && (
                <div
                    className="absolute top-16 left-0 w-full bg-white shadow-md md:hidden flex flex-col items-center space-y-4 py-4 z-50"
                >
                    <a href="#" className="hover:text-blue-600">Features</a>
                    <a href="#" className="hover:text-blue-600">Solutions</a>
                    <a onClick={() => navigate('/pricing')} className="hover:text-blue-600 cursor-pointer">Pricing</a>
